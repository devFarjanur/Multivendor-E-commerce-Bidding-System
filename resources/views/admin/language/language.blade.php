					...
					<div class="admin-menu__one sherah-sidebar-padding">
						...
						<div class="menu-bar">
							<ul class="menu-bar__one sherah-dashboard-menu" id="sherahMenu">
								...
								<li><a href="{{ route('admin.customer.page') }}" class="collapsed" data-bs-toggle="collapse" data-bs-target="#menu-item__customers"><span class="menu-bar__text">
									<span class="sherah-menu-icon sherah-svg-icon__v1">
									...
									<div class="collapse sherah__dropdown" id="menu-item__customers"  data-bs-parent="#sherahMenu">
										<ul class="menu-bar__one-dropdown">
											<li><a href="{{ route('admin.customer.list') }}"><span class="menu-bar__text"><span class="menu-bar__name">Customer List</span></span></a></li>
											<li><a href="{{ route('admin.customer.page') }}"><span class="menu-bar__text"><span class="menu-bar__name">Customers</span></span></a></li>
										  </ul>
									</div>
								</li>
								<li><a href="{{ route('admin.products') }}" class="collapsed" data-bs-toggle="collapse" data-bs-target="#menu-item_products"><span class="menu-bar__text">
									...
									<div class="collapse sherah__dropdown" id="menu-item_products" data-bs-parent="#sherahMenu">
										<ul class="menu-bar__one-dropdown">
											<li><a href="{{ route('admin.products') }}"><span class="menu-bar__text"><span class="menu-bar__name">Products</span></span></a></li>
											<li><a href="{{ route('admin.product.details') }}"><span class="menu-bar__text"><span class="menu-bar__name">Product Details</span></span></a></li>
											<li><a href="{{ route('admin.upload.products') }}"><span class="menu-bar__text"><span class="menu-bar__name">Upload Product</span></span></a></li>
										</ul>
									</div>
								</li>
								...
								<li><a href="#!" class="collapsed" data-bs-toggle="collapse" data-bs-target="#menu-item__orders"><span class="menu-bar__text">
									...
									<div class="collapse sherah__dropdown" id="menu-item__orders" data-bs-parent="#sherahMenu">
										<ul class="menu-bar__one-dropdown">
											<li><a href="{{ route('admin.order.list') }}"><span class="menu-bar__text"><span class="menu-bar__name">Order List</span></span></a></li>
											<li><a href="ute('admin.order.details') }}"><span class="menu-bar__text"><span class="menu-bar__name">Order Details</span></span></a></li>
										</ul>
									</div>
								</li>
											...
											<div class="row">
												<div class="col-lg-6 col-md-6 col-12">
													<div class="sherah-language-form mg-top-30">
														...
														<div class="flag-icon"><img src="{{ asset('backend/assets/img/flag-1.png') }}"></div>
													</div>
												</div>
												<div class="col-lg-6 col-md-6 col-12">
													<div class="sherah-language-form mg-top-30">
														...
														<div class="flag-icon"><img src="{{ asset('backend/assets/img/flag-2.png') }}"></div>
													</div>
												</div>
												<div class="col-lg-6 col-md-6 col-12">
													<div class="sherah-language-form mg-top-30">
														...
														<div class="flag-icon"><img src="{{ asset('backend/assets/img/flag-3.png') }}"></div>
													</div>
												</div>
												<div class="col-lg-6 col-md-6 col-12">
													<div class="sherah-language-form mg-top-30">
														...
														<div class="flag-icon"><img src="{{ asset('backend/assets/img/flag-4.png') }}"></div>
													</div>
												</div>
												<div class="col-lg-6 col-md-6 col-12">
													<div class="sherah-language-form mg-top-30">
														...
														<div class="flag-icon"><img src="{{ asset('backend/assets/img/flag-5.png') }}"></div>
													</div>
												</div>
												<div class="col-lg-6 col-md-6 col-12">
													<div class="sherah-language-form mg-top-30">
														...
														<div class="flag-icon"><img src="{{ asset('backend/assets/img/flag-6.png') }}"></div>
													</div>
												</div>
												<div class="col-lg-6 col-md-6 col-12">
													<div class="sherah-language-form mg-top-30">
														...
														<div class="flag-icon"><img src="{{ asset('backend/assets/img/flag-7.png') }}"></div>
													</div>
												</div>
												<div class="col-lg-6 col-md-6 col-12">
													<div class="sherah-language-form mg-top-30">
														...
														<div class="flag-icon"><img src="{{ asset('backend/assets/img/flag-8.png') }}"></div>
													</div>
												</div>
												<div class="col-lg-6 col-md-6 col-12">
													<div class="sherah-language-form mg-top-30">
														...
														<div class="flag-icon"><img src="{{ asset('backend/assets/img/flag-9.png') }}"></div>
													</div>
												</div>
												<div class="col-lg-6 col-md-6 col-12">
													<div class="sherah-language-form mg-top-30">
														...
														<div class="flag-icon"><img src="{{ asset('backend/assets/img/flag-10.png') }}"></div>
													</div>
												</div>
											</div>
