											...
											<ul class="sherah-paymentm__list sherah-paymentm__list--notify pt-0">
												...
												<li class="sherah-paymentm__single--notify sherah-border">
													<div class="sherah-paymentm__name">
														...
														<div class="sherah-paymentm__content">
															<h4 class="sherah-notifications__title">You have an offer! <span>successfully done</span></h4>
															<p class="sherah-paymentm__text sherah-paymentm__text--notify">10 hours ago</p>
														</div>
													</div>
												</li>
												<li class="sherah-paymentm__single--notify sherah-border">
													...
													<div class="sherah-paymentm__name">
														<div class="sherah-paymentm__icon sherah-paymentm__icon--notify ntfmax__bgc--3">
															<svg xmlns="http://www.w3.org/2000/svg" width="18.956" height="18.925" viewBox="0 0 18.956 18.925">
																<path id="star_1_" data-name="star (1)" d="M16.971,6.241l-5.36-.819L9.21.305a.567.567,0,0,0-.986,0l-2.4,5.117-5.36.819a.545.545,0,0,0-.307.919l3.894,3.991-.92,5.642a.545.545,0,0,0,.8.564l4.787-2.646L13.5,17.358a.545.545,0,0,0,.8-.564l-.92-5.642L17.279,7.16a.545.545,0,0,0-.307-.92Z" transform="translate(0.761 0.732)" fill="none" stroke="#fff" stroke-width="1.5"></path>
															</svg>
														</div>
														<div class="sherah-paymentm__content">
															<h4 class="sherah-notifications__title">A new rating has been <span>received</span></h4>
															<p class="sherah-paymentm__text sherah-paymentm__text--notify">2 days ago</p>
														</div>
													</div>
												</li>	
											</ul>
