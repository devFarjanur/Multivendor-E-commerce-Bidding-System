                                                            ...
                                                            <div class="col-12">
                                                                <div class="form-group">
                                                                    ...
                                                                    <div class="form-group__input">
                                                                        <input class="sherah-wc__form-input" placeholder="Type here" type="text" name="p_title">
                                                                    </div>
                                                                </div>
                                                            </div>
                                                ...
                                                <div class="col-lg-6 col-12">
                                                    ...
                                                    <div class="product-form-box sherah-border mg-top-30">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="form-group__input">
                                                                <input class="sherah-wc__form-input" placeholder="Type here" type="text" name="p_title">
                                                                <button class="sherah-btn__add sherah-btn sherah-btn__secondary" type="button">Add</button>
                                                            </div>
                                                        </div>
                                                        <div class="form-group">
                                                                ...
                                                                <div class="form-group">
                                                                    ...
                                                                    <div class="checkbox-group">
                                                                        <div class="checkbox-group__single">
                                                                            ...
                                                                            <label class="checkbox-group__single--label" for="option1">MM</label>
                                                                        </div>
                                                                        <div class="checkbox-group__single">
                                                                            <input type="checkbox" class="btn-check" name="options" id="option2"  checked autocomplete="off">
                                                                            <label class="checkbox-group__single--label" for="option2">XL</label>
                                                                        </div>
                                                                        <div class="checkbox-group__single">
                                                                            <input type="checkbox" class="btn-check" name="options" id="option3" autocomplete="off">
                                                                            <label class="checkbox-group__single--label" for="option3">M</label>
                                                                        </div>
                                                                        <div class="checkbox-group__single">
                                                                            <input type="checkbox" class="btn-check" name="options" id="option4" autocomplete="off">
                                                                            <label class="checkbox-group__single--label" for="option4">MM</label>
                                                                        </div>
                                                                        <div class="checkbox-group__single">
                                                                            <input type="checkbox" class="btn-check" name="options" id="option5" autocomplete="off">
                                                                            <label class="checkbox-group__single--label" for="option5">X</label>
                                                                        </div>
                                                                        <div class="checkbox-group__single">
                                                                            <input type="checkbox" class="btn-check" name="options" id="option6" autocomplete="off">
                                                                            <label class="checkbox-group__single--label" for="option6">SM</label>
                                                                        </div>
                                                                        <div class="checkbox-group__single">
                                                                            <input type="checkbox" class="btn-check" name="options" id="option7" autocomplete="off">
                                                                            <label class="checkbox-group__single--label" for="option7">2X</label>
                                                                        </div>
                                                                        <div class="checkbox-group__single">
                                                                            <input type="checkbox" class="btn-check" name="options" id="option8" autocomplete="off">
                                                                            <label class="checkbox-group__single--label" for="option8">3X</label>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                                ...
                                                                <div class="form-group">
                                                                    ...
                                                                    <div class="checkbox-group">
                                                                        <div class="checkbox-group__single">
                                                                            ...
                                                                            <label class="checkbox-group__single--label" for="option9">White</label>
                                                                        </div>
                                                                        <div class="checkbox-group__single">
                                                                            <input type="checkbox" class="btn-check" name="options" id="option10"  checked autocomplete="off">
                                                                            <label class="checkbox-group__single--label" for="option10">Black</label>
                                                                        </div>
                                                                        <div class="checkbox-group__single">
                                                                            <input type="checkbox" class="btn-check" name="options" id="option11" autocomplete="off">
                                                                            <label class="checkbox-group__single--label" for="option11">Harlequin</label>
                                                                        </div>
                                                                        <div class="checkbox-group__single">
                                                                            <input type="checkbox" class="btn-check" name="options" id="option12" autocomplete="off">
                                                                            <label class="checkbox-group__single--label" for="option12">Red</label>
                                                                        </div>
                                                                        <div class="checkbox-group__single">
                                                                            <input type="checkbox" class="btn-check" name="options" id="option13" autocomplete="off">
                                                                            <label class="checkbox-group__single--label" for="option13">Yellow</label>
                                                                        </div>
                                                                        <div class="checkbox-group__single">
                                                                            <input type="checkbox" class="btn-check" name="options" id="option14" autocomplete="off">
                                                                            <label class="checkbox-group__single--label" for="option14">Blue</label>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                ...
                                                <div class="form-group">
                                                    <div class="image-upload-group">
                                                        ...
                                                        <div class="image-upload-group__single image-upload-group__single--upload">
                                                            <input type="file" class="btn-check" name="options" id="input-img1" autocomplete="off">
