                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-xxl-9 col-lg-8 col-12">
                                            <div class="sherah-breadcrumb__right mg-top-30">
                                                ...
                                                <div class="sherah-breadcrumb__right--second">
                                                    <div class="sherah-product__nav list-group " id="list-tab" role="tablist">
                                                        <a class="list-group-item active" data-bs-toggle="list" href="#tab_1" role="tab" href="profile.html"><span>Top Rated</span></a>
                                                        <a class="list-group-item" data-bs-toggle="list" href="#tab_2" role="tab"><span>Popular</span></a>
                                                        <a class="list-group-item" data-bs-toggle="list" href="#tab_1" role="tab"><span>Newest</span></a>
                                                    </div>
                                                    <a href="{{ route('admin.upload.products') }}" class="sherah-btn sherah-gbcolor">Upload Product</a>
                                                </div>
                                            </div>
                                            <div class="tab-content" id="nav-tabContent">
                                                ...
                                                <div class="tab-pane fade show" id="tab_2" role="tabpanel" aria-labelledby="nav-home-tab">
                                                    <div class="row">
