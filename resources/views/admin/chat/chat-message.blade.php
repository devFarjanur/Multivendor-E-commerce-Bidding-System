                ...
                <div class="admin-menu__one sherah-sidebar-padding">
                    ...
                    <div class="menu-bar">
                        <ul class="menu-bar__one sherah-dashboard-menu" id="sherahMenu">
                            ...
                            <li><a href="{{ route('admin.vendor.grid') }}" class="collapsed" data-bs-toggle="collapse"
                                ...
                                <div class="collapse sherah__dropdown" id="menu-item_vendors" data-bs-parent="#sherahMenu">
                                    <ul class="menu-bar__one-dropdown">
                                        ...
                                        <li><a href="{{ route('admin.vendor.profile') }}"><span class="menu-bar__text"><span
                                                        class="menu-bar__name">Vendor Profile</span></span></a></li>
                                    </ul>
                                </div>
                            </li>
                            <li><a href="{{ route('admin.customer.page') }}" class="collapsed" data-bs-toggle="collapse"
                                ...
                                <div class="collapse sherah__dropdown" id="menu-item__customers"
                                    ...
                                    <ul class="menu-bar__one-dropdown">
                                        <li><a href="{{ route('admin.customer.list') }}"><span
                                                    class="menu-bar__text"><span class="menu-bar__name">Customer
                                                        List</span></span></a></li>
                                        <li><a href="{{ route('admin.customer.page') }}"><span
                                                    class="menu-bar__text"><span
                                                        class="menu-bar__name">Customers</span></span></a></li>
                                    </ul>
                                </div>
                            </li>
                            <li><a href="{{ route('admin.products') }}" class="collapsed" data-bs-toggle="collapse"
                                ...
                                <div class="collapse sherah__dropdown" id="menu-item_products"
                                    ...
                                    <ul class="menu-bar__one-dropdown">
                                        ...
                                        <li><a href="{{ route('admin.product.details') }}"><span
                                                    class="menu-bar__text"><span class="menu-bar__name">Product
                                                        Details</span></span></a></li>
                                        <li><a href="{{ route('admin.upload.products') }}"><span
                            ...
                            <li><a href="#" class="collapsed" data-bs-toggle="collapse"
                                ...
                                <div class="collapse sherah__dropdown" id="menu-item__orders"
                                    ...
                                    <ul class="menu-bar__one-dropdown">
                                        ...
                                        <li><a href="{{ route('admin.order.details') }}"><span
                            ...
                            <li><a href="{{ route('admin.chat.message') }}" class="collapsed"><span
                                        class="menu-bar__text">
                                        <span class="sherah-menu-icon sherah-svg-icon__v1">
                                            <svg class="sherah-svg-icon" xmlns="http://www.w3.org/2000/svg"
                            ...
                            <li><a href="#!" class="collapsed" data-bs-toggle="collapse"
                                ...
                                <div class="collapse sherah__dropdown" id="menu-item__9" data-bs-parent="#sherahMenu">
                                    <ul class="menu-bar__one-dropdown">
                                        <li><a href="{{ route('admin.pages.notifications') }}"><span
                                                    class="menu-bar__text"><span
                                                    ...
                                                    <div class="sherah-chatbox__top">
                                                        ...
                                                        <form class="sherah-chatbox-form" action="#">
                                                            ...
                                                            <button class="search-btn" type="submit">
                                                                <svg class="sherah-color1__fill" width="16"
                                                                    ...
                                                                    <div class="sherah-chatbox__chat">
                                                                        <div
                                                                            ...
                                                                            <img src="{{ asset('backend/assets/img/chat-author10.png') }}"
                                                                                alt="#">
                                                                            <span
                                                                                class="sherah-chatbox__author-online"></span>
                                                                        </div>
