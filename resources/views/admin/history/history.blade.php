							...
							<ul class="menu-bar__one sherah-dashboard-menu" id="sherahMenu">
								...
								<li><a href="{{ route('admin.customer.page') }}" class="collapsed" data-bs-toggle="collapse" data-bs-target="#menu-item__customers"><span class="menu-bar__text">
									...
									<div class="collapse sherah__dropdown" id="menu-item__customers"  data-bs-parent="#sherahMenu">
										<ul class="menu-bar__one-dropdown">
											<li><a href="{{ route('admin.customer.page') }}"><span class="menu-bar__text"><span class="menu-bar__name">Customer List</span></span></a></li>
											<li><a href="{{ route('admin.customer.list') }}"><span class="menu-bar__text"><span class="menu-bar__name">Customers</span></span></a></li>
										  </ul>
									</div>
								</li>
                                                    ...
                                                    <div class="row sherah-flex-between">
                                                        ...
                                                        <div class="col-lg-6 col-12">
                                                            <div class="sherah-grap-chart">
                                                                <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="244.049" height="207.741" viewBox="0 0 244.049 207.741">
                                                                    <defs>
                                                        ...
                                                        <table id="sherah-table__main" class="sherah-table__main sherah-table__main-v1">
                                                            ...
                                                            <thead class="sherah-table__head">
                                                                <tr>
                                                                    ...
                                                                    <th class="sherah-table__column-2 sherah-table__h2">Project Name</th>
                                                                    <th class="sherah-table__column-3 sherah-table__h3">Start Date</th>
                                                                    <th class="sherah-table__column-4 sherah-table__h4">End Date</th>
                                                            ...
                                                            <tbody class="sherah-table__body">
                                                                <tr>
                                                                    <td class="sherah-table__column-1 sherah-table__data-1">
                                                                        <div class="sherah-table__product--id">
                                                                            <p class="crany-table__product--number"><a href="#">01</a></p>
                                                                        </div>
                                                                    </td>
                                                                    <td class="sherah-table__column-2 sherah-table__data-2">
                                                                        <div class="sherah-table__product-content">
                                                                            <p class="sherah-table__product-desc">Polka Dots Woman Dress</p>
                                                                        </div>
                                                                    </td>
                                                                    <td class="sherah-table__column-3 sherah-table__data-3">
                                                                        <div class="sherah-table__product-content">
                                                                            <p class="sherah-table__product-desc">11 / 03 / 2022</p>
                                                                        </div>
                                                                    </td>
                                                                    <td class="sherah-table__column-4 sherah-table__data-4">
                                                                        <div class="sherah-table__product-content">
                                                                            <p class="sherah-table__product-desc">20 / 03 / 2022</p>
                                                                        </div>
                                                                    </td>
                                                                    <td class="sherah-table__column-5 sherah-table__data-5">
                                                                        <div class="sherah-table__status sherah-color2 sherah-color2__bg--opactity">Done</div>
                                                                    </td>
                                                                ...
                                                                <tr>
                                                                    <td class="sherah-table__column-1 sherah-table__data-1">
                                                                        <div class="sherah-table__product--id">
                                                                            <p class="crany-table__product--number"><a href="#">02</a></p>
                                                                        </div>
                                                                    </td>
                                                                    <td class="sherah-table__column-2 sherah-table__data-2">
                                                                        <div class="sherah-table__product-content">
                                                                            <p class="sherah-table__product-desc">Sweater For Women</p>
                                                                        </div>
                                                                    </td>
                                                                    <td class="sherah-table__column-3 sherah-table__data-3">
                                                                        <div class="sherah-table__product-content">
                                                                            <p class="sherah-table__product-desc">18 / 03 / 2022</p>
                                                                        </div>
                                                                    </td>
                                                                    <td class="sherah-table__column-4 sherah-table__data-4">
                                                                        <div class="sherah-table__product-content">
                                                                            <p class="sherah-table__product-desc">25 / 03 / 2022</p>
                                                                        </div>
                                                                    </td>
                                                                    <td class="sherah-table__column-5 sherah-table__data-5">
                                                                        <div class="sherah-table__status sherah-color3 sherah-color3__bg--opactity">Review</div>
                                                                    </td>
                                                                    <td class="sherah-table__column-7 sherah-table__data-7">
                                                                ...
                                                                <tr>
                                                                    <td class="sherah-table__column-1 sherah-table__data-1">
                                                                        <div class="sherah-table__product--id">
                                                                            <p class="crany-table__product--number"><a href="#">03</a></p>
                                                                        </div>
                                                                    </td>
                                                                    <td class="sherah-table__column-2 sherah-table__data-2">
                                                                        <div class="sherah-table__product-content">
                                                                            <p class="sherah-table__product-desc">Convert for man shoe</p>
                                                                        </div>
                                                                    </td>
                                                                    <td class="sherah-table__column-3 sherah-table__data-3">
                                                                        <div class="sherah-table__product-content">
                                                                            <p class="sherah-table__product-desc">20 / 02 / 2022</p>
                                                                        </div>
                                                                    </td>
                                                                    <td class="sherah-table__column-4 sherah-table__data-4">
                                                                        <div class="sherah-table__product-content">
                                                                            <p class="sherah-table__product-desc">28 / 02 / 2022</p>
                                                                        </div>
                                                                    </td>
                                                                    <td class="sherah-table__column-5 sherah-table__data-5">
                                                                        <div class="sherah-table__status sherah-color2 sherah-color2__bg--opactity">Done</div>
                                                                ...
                                                                <tr>
                                                                    <td class="sherah-table__column-1 sherah-table__data-1">
                                                                        <div class="sherah-table__product--id">
                                                                            <p class="crany-table__product--number"><a href="#">04</a></p>
                                                                        </div>
                                                                    </td>
                                                                    <td class="sherah-table__column-2 sherah-table__data-2">
                                                                        <div class="sherah-table__product-content">
                                                                            <p class="sherah-table__product-desc">Luxury T-shirt  For men</p>
                                                                        </div>
                                                                    </td>
                                                                    <td class="sherah-table__column-3 sherah-table__data-3">
                                                                        <div class="sherah-table__product-content">
                                                                            <p class="sherah-table__product-desc">28 / 03 / 2022</p>
                                                                        </div>
                                                                    </td>
                                                                    <td class="sherah-table__column-4 sherah-table__data-4">
                                                                        <div class="sherah-table__product-content">
                                                                            <p class="sherah-table__product-desc">15 / 04 / 2022</p>
                                                                        </div>
                                                                    </td>
                                                                    <td class="sherah-table__column-5 sherah-table__data-5">
                                                                        <div class="sherah-table__status sherah-color1 sherah-color1__bg--opactity">Coming Soon</div>
                                                                    </td>
                                                                    <td class="sherah-table__column-7 sherah-table__data-7">
                                                                        <p class="sherah-table__product-desc">Un publish</p>
                                                                    </td>
		...
		<script>
			...
			const myChart_Total_Daily_visitor = new Chart(ctx_two, {
				...
				data: {
					...
					datasets: [{
						label: 'Visitor',
						data: [20, 15, 35, 45, 60, 45, 70, 50, 70, 70, 44, 50, 45, 60, 45, 70, 50, 70, 70, 44, 50, 45, 60, 45, 70, 50, 70, 70, 44, 50, 66],
			...
			const myChart_Visitor = new Chart(ctx_market, {
				...
				data: {
					...
					datasets: [{
						label: 'Visitor',
						data: [40, 45, 75, 90, 90, 45, 45, 45, 70, 70, 55, 80],
					...
					{
						label: 'Sells',
						data: [55, 55, 55, 30, 60, 45, 70, 50, 70, 30, 95, 70],
						backgroundColor: 'transparent',
						borderColor:'#6176FE',
						borderWidth:5,
						fill:true,
