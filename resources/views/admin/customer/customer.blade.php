                                        ...
                                        <div class="col-12 sherah-flex-between">
                                            ...
                                            <div class="sherah-breadcrumb">
                                                ...
                                                <ul class="sherah-breadcrumb__list"> 
                                                    <li><a href="#">Home</a></li>
                                                    <li class="active"><a href="{{ route('admin.customer.page') }}">Customers</a></li>
                                                </ul>
                                            </div>
                                            ...
                                            <div class="col-lg-3 col-12 mg-top-30">
                                                <div class="sherah-upcard">
													<div class="sherah-upcard__thumb">
														<img src="{{ asset('backend/assets/img/customer-profile.png') }}" alt="#">
													</div>
													<div class="sherah-upcard__heading">
                                                        ...
                                                        <p class="sherah-upcard__email"><a href="mailto:margaretraw@gmail.com">margaretraw@gmail.com</a></p>
													</div>
													<div class="sherah-upcard__balance sherah-default-bg sherah-border">Balance $1200</div>
													...
													<table id="sherah-table__vendor" class="sherah-table__main sherah-table__main-v3">
														<tbody class="sherah-table__body">
															<tr>
																<td class="sherah-table__column-1 sherah-table__data-1">
																	<div class="sherah-table__product--id">
																		<p class="crany-table__product--number"><a href="#" class="sherah-color1">#Kz025417</a></p>
																	</div>
																</td>
															...
															<tr>
																<td class="sherah-table__column-1 sherah-table__data-1">
																	<div class="sherah-table__product--id">
																		<p class="crany-table__product--number"><a href="#" class="sherah-color1">#80293</a></p>
																	</div>
																</td>
																<td class="sherah-table__column-2 sherah-table__data-2">
																	<div class="sherah-table__product-content">
															...
															<tr>
																<td class="sherah-table__column-1 sherah-table__data-1">
																	<div class="sherah-table__product--id">
																		<p class="crany-table__product--number"><a href="#" class="sherah-color1">#78621</a></p>
																	</div>
																</td>
																<td class="sherah-table__column-2 sherah-table__data-2">
																	<div class="sherah-table__product-content">
                                                        ...
                                                        <div class="sherah-accounts-card">
                                                            ...
                                                            <div class="sherah-accounts-card__header sherah-border-btm mg-btm-30 pd-btm-30">
                                                                ...
                                                                <a href="#" class="sherah-accounts-card__button">
                                                                    <svg class="sherah-color3__fill" xmlns="http://www.w3.org/2000/svg" width="21" height="21.031" viewBox="0 0 21 21.031">
