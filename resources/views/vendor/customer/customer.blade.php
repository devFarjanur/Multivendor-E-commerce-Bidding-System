                                ...
                                <div class="col-12 sherah-flex-between">
                                    ...
                                    <div class="sherah-breadcrumb">
                                        ...
                                        <ul class="sherah-breadcrumb__list">
                                            <li><a href="#">Home</a></li>
                                            <li class="active"><a href="{{ route('admin.customer.page') }}">Customers</a>
                                            </li>
                                        </ul>
                                    </div>
                                ...
                                <div class="row">
                                    <div class="col-lg-3 col-12 mg-top-30">
                                        <div class="sherah-upcard">
                                            ...
                                            <div class="sherah-upcard__balance sherah-default-bg sherah-border">Balance
                                                $1200</div>
                                            <ul class="sherah-upcard__list mg-top-40">
                                                <li>
                                                    <b>Last Order</b>
                                                    <span>7 days ago – <a class="sherah-color1">#80294</a></span>
                                                </li>
                                                <li>
                                        ...
                                        <div class="row">
                                            <div class="col-lg-6 col-md-6 col-12 mg-top-30">
                                                <div class="sherah-accounts-card">
                                                    <!-- Sherah Card Header-->
                                                    <div
                                                        class="sherah-accounts-card__header sherah-border-btm mg-btm-30 pd-btm-30">
                                                        ...
                                                        <a href="#" class="sherah-accounts-card__button">
                                                            <svg class="sherah-color3__fill"
                                                                ...
                                                                height="21.031" viewBox="0 0 21 21.031">
                                            ...
                                            <div class="col-lg-6 col-md-6 col-12 mg-top-30">
                                                <div class="sherah-accounts-card">
                                                    ...
                                                    <div
                                                        class="sherah-accounts-card__header sherah-border-btm mg-btm-30 pd-btm-30">
                                                        <h3 class="sherah-accounts-card__title">Credit Card</h3>
                                                        <a href="#" class="sherah-accounts-card__button">
                                                            <svg class="sherah-color3__fill"
                                                                xmlns="http://www.w3.org/2000/svg" width="21"
                                                                height="21.031" viewBox="0 0 21 21.031">
                                                    ...
                                                    <div class="sherah-accounts-card__body">
                                                        <ul class="sherah-accounts-card__list">
                                                            ...
                                                            <li>Card Holder: <span>Margaret Raw</span></li>
                                                            <li>Expire: <span>20 May 2026</span></li>
                                                            <li>Card Number: <span>5698 5236 3288 7766</span></li>
                                                            <li>Balance: <span>1200</span></li>
                                                        </ul>
                                                    </div>
                                                    <!-- End Sherah Card Body -->
                                                </div>
