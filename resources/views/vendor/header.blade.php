                  ...
                  <div class="sherah-header__right">
                    ...
                    <div class="sherah-dark-light">
                      <button id="sherah-dark-light-button">
                        <svg class="sherah-offset__fill" xmlns="http://www.w3.org/2000/svg" width="26.536" height="26"
                    ...
                    <div class="sherah-header__zoom">
                      <button id="sherah-header__full">
                        <svg class="sherah-offset__fill" xmlns="http://www.w3.org/2000/svg" width="33.674" height="26"
                    ...
                    <div class="sherah-header__dropmenu sherah-header__dropmenu--messages">
                      ...
                      <svg class="sherah-offset__fill" xmlns="http://www.w3.org/2000/svg" width="28.08" height="26.196"
                      ...
                      <div class="sherah-dropdown-card sherah-dropdown-card__alarm sherah-border">
                        <svg class="sherah-dropdown-arrow" xmlns="http://www.w3.org/2000/svg" width="43.488"
                          height="22.207" viewBox="0 0 43.488 22.207">
                          <path id="Path_1271" data-name="Path 1271" d="M-15383,7197.438l20.555-20.992,20.555,20.992Z"
                        ...
                        <ul class="sherah-dropdown-card_list sherah-chatbox__list sherah-chatbox__list__header">
                            ...
                            <div class="sherah-chatbox__inner">
                              <div class="sherah-chatbox__author">
                                <div class="sherah-chatbox__author-img">
                                  <img src="{{ asset('backend/assets/img/chat-author1.png') }}" alt="#">
                          ...
                          <li>
                            <div class="sherah-chatbox__inner">
                              <div class="sherah-chatbox__author">
                                <div class="sherah-chatbox__author-img">
                                  <img src="{{ asset('backend/assets/img/chat-author2.png') }}" alt="#">
                          ...
                          <li>
                            <div class="sherah-chatbox__inner">
                              <div class="sherah-chatbox__author">
                                <div class="sherah-chatbox__author-img">
                                  <img src="{{ asset('backend/assets/img/chat-author3.png') }}" alt="#">
                                  <span class="sherah-chatbox__author-online author-not-online"></span>
                                </div>
                                <div class="sherah-chatbox__author-content">
                          ...
                          <li>
                            <div class="sherah-chatbox__inner">
                              <div class="sherah-chatbox__author">
                                <div class="sherah-chatbox__author-img">
                                  <img src="{{ asset('backend/assets/img/chat-author4.png') }}" alt="#">
                                  <span class="sherah-chatbox__author-online"></span>
                                </div>
                                <div class="sherah-chatbox__author-content">
                          ...
                          <li>
                            <div class="sherah-chatbox__inner">
                              <div class="sherah-chatbox__author">
                                <div class="sherah-chatbox__author-img">
                                  <img src="{{ asset('backend/assets/img/chat-author5.png') }}" alt="#">
                        ...
                        <div class="sherah-dropdown-card__button"><a href="chat-messages.html"
                            class="sherah-dropdown-card__sell-all">See all Notification</a></div>
                      </div>
                    ...
                    <div class="sherah-header__dropmenu">
                      <svg class="sherah-offset__fill" id="Icon" xmlns="http://www.w3.org/2000/svg" width="22.875"
                        height="25.355" viewBox="0 0 22.875 25.355">
                          ...
                          <li>
                            <div class="sherah-paymentm__name">
                              <div class="sherah-paymentm__icon sherah-paymentm__icon--notify ntfmax__bgc--5">
                                <svg xmlns="http://www.w3.org/2000/svg" width="48" height="48" viewBox="0 0 48 48">
                                  <g id="Icon" transform="translate(14.293 11.5)">
                                    <circle id="Ellipse_34" data-name="Ellipse 34" cx="24" cy="24" r="24"
                                      transform="translate(-14.293 -11.5)" fill="#6176fe"></circle>
                                    <g id="Group_55" data-name="Group 55" transform="translate(-0.611 1.038)">
                                      <g id="Group_54" data-name="Group 54" transform="translate(0 0)">
                                        <path id="Path_188" data-name="Path 188"
                                          ...
                                          transform="translate(-10.359 0.002)" fill="#fff" stroke="#fff"
                                    ...
                                    <g id="Group_57" data-name="Group 57" transform="translate(5.343 7.675)">
                                      <g id="Group_56" data-name="Group 56">
                                        <path id="Path_189" data-name="Path 189"
                                          ...
                                          transform="translate(-143.792 -143.792)" fill="#fff" stroke="#fff"
                                          stroke-width="0.2"></path>
                                      </g>
                                    </g>
                                    <g id="Group_59" data-name="Group 59" transform="translate(5.299 6.666)">
                                      <g id="Group_58" data-name="Group 58" transform="translate(0)">
                                        <path id="Path_190" data-name="Path 190"
                                          ...
                                          transform="translate(-142.802 -123.116)" fill="#fff" stroke="#fff"
                                          stroke-width="0.2"></path>
                                      </g>
                                    </g>
                                    <g id="Group_61" data-name="Group 61" transform="translate(10.569 13.867)">
                                      <g id="Group_60" data-name="Group 60">
                                        <path id="Path_191" data-name="Path 191"
                                          ...
                                          transform="translate(-260.922 -280.61)" fill="#fff" stroke="#fff"
                                          stroke-width="0.2"></path>
                                      </g>
                                    </g>
                                  </g>
                              ...
                              <div class="sherah-paymentm__content">
                                <h4 class="sherah-notifications__title">You have an offer! <span>successfully
                                    done</span></h4>
                          ...
                          <li>
                            <div class="sherah-paymentm__name">
                              <div class="sherah-paymentm__icon sherah-paymentm__icon--notify ntfmax__bgc--2">
                                <svg xmlns="http://www.w3.org/2000/svg" width="17.272" height="17.272"
                                  ...
                                  <g id="jigsaw" transform="translate(0 0)">
                                    ...
                                    <path id="Path_193" data-name="Path 193"
                                      ...
                                      transform="translate(0 -98.559)" fill="#fff"></path>
                                  </g>
                                </svg>
                              </div>
                              <div class="sherah-paymentm__content">
                                <h4 class="sherah-notifications__title">You upload your fast product <span>successfully
                                    done</span></h4>
                          ...
                          <li>
                            <div class="sherah-paymentm__name">
                              <div class="sherah-paymentm__icon sherah-paymentm__icon--notify ntfmax__bgc--3">
                                <svg xmlns="http://www.w3.org/2000/svg" width="17.723" height="15.196"
                                  ...
                                  <path id="Path_194" data-name="Path 194"
                                    ...
                                    transform="translate(-2 -3.999)" fill="#fff"></path>
                                </svg>
                              </div>
                              <div class="sherah-paymentm__content">
                                <h4 class="sherah-notifications__title">Your Account has been created <span>successfully
                                    done</span></h4>
                          ...
                          <li>
                            <div class="sherah-paymentm__name">
                              <div class="sherah-paymentm__icon sherah-paymentm__icon--notify ntfmax__bgc--4">
                                <svg xmlns="http://www.w3.org/2000/svg" width="15.964" height="21.016"
                                  ...
                                  <g id="Group_1033" data-name="Group 1033" transform="translate(-1018.595 85.089)">
                                    ...
                                    <path id="Path_1040" data-name="Path 1040"
                                      ...
                                      transform="translate(-68.335 -104.403)" fill="#fff"></path>
                                  </g>
                                </svg>
                              </div>
                              <div class="sherah-paymentm__content">
                                <h4 class="sherah-notifications__title">Thank you !you made your fast sell
                                  <span>$120</span></h4>
                    ...
                    <div class="sherah-header__author sherah-flex__center--top">
                      <div class="sherah-header__author-img">
                        <img src="{{ asset('backend/assets/img/profile-pic.png') }}" alt="#">
                      </div>
                      <div class="sherah-header__author--info sherah-dflex sherah-dflex__base">
                        <h4 class="sherah-header__author--title  sherah-dflex sherah-dflex__column">Anthony <span
                            class="sherah-header__author--text">USA</span></h4>
                        <svg class="sherah-default__fill sherah-default__arrow" xmlns="http://www.w3.org/2000/svg"
                          width="10.621" height="5.836" viewBox="0 0 10.621 5.836">
                      ...
                      <div class="sherah-dropdown-card sherah-dropdown-card__profile sherah-border">
                        ...
                        <ul class="sherah-dropdown-card_list">
                          <li>
                            <div class="sherah-dropdown-card-info">
                              <div class="sherah-dropdown-card__img sherah-color1__bg">
                                <svg xmlns="http://www.w3.org/2000/svg" width="18.192" height="21.5"
                          ...
                          <li>
                            <div class="sherah-dropdown-card-info">
                              <div class="sherah-dropdown-card__img sherah-color1__bg">
                                <svg xmlns="http://www.w3.org/2000/svg" width="22.029" height="22.368"
                          ...
                          <li>
                            <div class="sherah-dropdown-card-info">
                              <div class="sherah-dropdown-card__img sherah-color1__bg">
                                <svg xmlns="http://www.w3.org/2000/svg" width="22.103" height="22.368"
