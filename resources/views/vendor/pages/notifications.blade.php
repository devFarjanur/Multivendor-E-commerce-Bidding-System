                ...
                <div class="col-12">
                    <div class="sherah-body">
                        ...
                        <div class="sherah-dsinner">
                            <div class="sherah-notifications sherah-default-bg sherah-border mg-top-40">
                                <div class="sherah-notifications__inner sherah-border">
                                    <ul class="sherah-paymentm__list sherah-paymentm__list--notify pt-0">

                                        <li class="sherah-paymentm__single--notify sherah-border">
                                            <div class="sherah-paymentm__name">
                                                <div
                                                    ...
                                                    <svg xmlns="http://www.w3.org/2000/svg" width="48" height="48"
                                                        ...
                                                        <g id="Icon" transform="translate(14.293 11.5)">
                                                            <circle id="Ellipse_34" data-name="Ellipse 34" cx="24"
                                                                cy="24" r="24" transform="translate(-14.293 -11.5)"
                                                                fill="#6176fe" />
                                                            <g id="Group_55" data-name="Group 55"
                                                                ...
                                                                <g id="Group_54" data-name="Group 54"
                                                                    ...
                                                                    <path id="Path_188" data-name="Path 188"
                                                                        ...
                                                                        transform="translate(-10.359 0.002)" fill="#fff"
                                                ...
                                                <div class="sherah-paymentm__content">
                                                    <h4 class="sherah-notifications__title">You have an offer!
                                                        <span>successfully done</span>
                                                    </h4>
                                                    <p class="sherah-paymentm__text sherah-paymentm__text--notify">20
                                                        minutes ago</p>
                                                </div>
                                            </div>
                                        </li>
                                                    ...
                                                    <svg xmlns="http://www.w3.org/2000/svg" width="17.272" height="17.272"
                                                        ...
                                                        <g id="jigsaw" transform="translate(0 0)">
                                                            ...
                                                            <path id="Path_193" data-name="Path 193"
                                                                ...
                                                                transform="translate(0 -98.559)" fill="#fff" />
                                                        </g>
                                                    </svg>
                                                </div>
                                                <div class="sherah-paymentm__content">
                                                    <h4 class="sherah-notifications__title">You upload your fast product
                                                        <span>successfully done</span>
                                                    </h4>
                                                    <p class="sherah-paymentm__text sherah-paymentm__text--notify">3 hours
                                                        ago </p>
                                                </div>
                                            </div>
                                        </li>
                                                ...
                                                <div
                                                    ...
                                                    <svg xmlns="http://www.w3.org/2000/svg" width="17.723" height="15.196"
                                                        ...
                                                        <path id="Path_194" data-name="Path 194"
                                                            ...
                                                            transform="translate(-2 -3.999)" fill="#fff" />
                                                    </svg>
                                                </div>
                                                <div class="sherah-paymentm__content">
                                                    <h4 class="sherah-notifications__title">Your Account has been created
                                                        <span>successfully done</span>
                                                    </h4>
                                                    <p class="sherah-paymentm__text sherah-paymentm__text--notify">5 hours
                                                        ago</p>
                                                </div>
                                            </div>
                                        </li>
                                                    ...
                                                    <svg xmlns="http://www.w3.org/2000/svg" width="15.964"
                                                        ...
                                                        <g id="Group_1033" data-name="Group 1033"
                                                            ...
                                                            <path id="Path_1040" data-name="Path 1040"
                                                                ...
                                                                transform="translate(-68.335 -104.403)" fill="#fff" />
                                                        </g>
                                                    </svg>
                                                </div>
                                                <div class="sherah-paymentm__content">
                                                    <h4 class="sherah-notifications__title">Thank you !you made your fast
                                                        sell <span>$120</span></h4>
                                                    <p class="sherah-paymentm__text sherah-paymentm__text--notify">6 hours
                                                        ago</p>
                                                </div>
                                            </div>
                                        </li>
                                        <li class="sherah-paymentm__single--notify sherah-border">
                                            <div class="sherah-paymentm__name">
                                                ...
                                                <div class="sherah-paymentm__content">
                                                    ...
                                                    <p class="sherah-paymentm__text sherah-paymentm__text--notify">10 hours
                                                        ago</p>
                                                </div>
                                            </div>
                                        </li>
                                        <li class="sherah-paymentm__single--notify sherah-border">
                                            <div class="sherah-paymentm__name">
                                                <div
                                                    class="sherah-paymentm__icon sherah-paymentm__icon--notify ntfmax__bgc--2">
                                                    <svg xmlns="http://www.w3.org/2000/svg" width="20.036"
                                                        height="18.364" viewBox="0 0 20.036 18.364">
                                                        <g id="Icon" transform="translate(1.214 -0.038)">
                                                            <path id="Path_33" data-name="Path 33"
                                                                ...
                                                                transform="translate(-1.214 -16.859)" fill="#fff">
                                                            </path>
                                                        </g>
                                                    </svg>
                                                </div>
                                                <div class="sherah-paymentm__content">
                                                    <h4 class="sherah-notifications__title">Best favorite product
                                                        <span>saved</span>
                                                    </h4>
                                                    <p class="sherah-paymentm__text sherah-paymentm__text--notify">1 day
                                                        ago </p>
                                                </div>
                                            </div>
                                        </li>
                                        <li class="sherah-paymentm__single--notify sherah-border">
                                            <div class="sherah-paymentm__name">
                                                <div
                                                    class="sherah-paymentm__icon sherah-paymentm__icon--notify ntfmax__bgc--3">
                                                    <svg xmlns="http://www.w3.org/2000/svg" width="18.956"
                                                        height="18.925" viewBox="0 0 18.956 18.925">
                                                        <path id="star_1_" data-name="star (1)"
                                                            ...
                                                            transform="translate(0.761 0.732)" fill="none"
                                                            stroke="#fff" stroke-width="1.5"></path>
                                                    </svg>
                                                </div>
                                                <div class="sherah-paymentm__content">
                                                    <h4 class="sherah-notifications__title">A new rating has been
                                                        <span>received</span>
                                                    </h4>
                                                    <p class="sherah-paymentm__text sherah-paymentm__text--notify">2 days
                                                        ago</p>
                                                </div>
                                            </div>
                                        </li>
                                    </ul>
                                    <a href="#" class="sherah-btn mg-top-40">View All Notifications</a>
                                </div>
                            </div>
                        </div>
                        <!-- End Dashboard Inner -->
