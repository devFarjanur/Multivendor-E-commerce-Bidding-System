                    ...
                    <div class="sherah-body">
                        ...
                        <div class="sherah-dsinner">
                            ...
                            <div class="sherah-page-inner sherah-border sherah-basic-page sherah-default-bg mg-top-25 p-0">
                                <form class="sherah-wc__form-main" action="#">
                                    <div class="row">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-12">
                                                        <div class="form-group">
                                                            ...
                                                            <div class="form-group__input">
                                                                <textarea class="sherah-wc__form-input" placeholder="Type here" type="text" name="p_title"></textarea>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="col-lg-6 col-md-6 col-12">
                                                    ...
                                                    <div class="col-lg-6 col-md-6 col-12">
                                                        <div class="form-group">
                                                            <label class="sherah-wc__form-label">Shipping Free</label>
                                                            <div class="form-group__input">
                                                                <input class="sherah-wc__form-input" placeholder="Type here"
                                                                    type="text" name="p_title">
                                                            </div>
                                                    ...
                                                    <div class="col-lg-6 col-md-6 col-12">
                                                        <div class="form-group">
                                                            <label class="sherah-wc__form-label">Tax Rate</label>
                                                            <div class="form-group__input">
                                                                <input class="sherah-wc__form-input" placeholder="Type here"
                                                                    type="text" name="p_title">
                                                            </div>
                                                    ...
                                                    <div class="col-12">
                                                        <div class="form-group">
                                                            ...
                                                            <div class="form-group__input">
                                                                <textarea class="sherah-wc__form-input" placeholder="Tag type here" type="text" name="p_title"></textarea>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                        ...
                                        <div class="col-lg-6 col-12">
                                            ...
                                            <div class="product-form-box sherah-border mg-top-30">
                                                ...
                                                <div class="form-group">
                                                    <label class="sherah-wc__form-label">Add Color</label>
                                                    <div class="form-group__input">
                                                        <input class="sherah-wc__form-input" placeholder="Type here"
                                                            type="text" name="p_title">
                                                        <button class="sherah-btn__add sherah-btn sherah-btn__secondary"
                                                ...
                                                <div class="form-group">
                                                    <label class="sherah-wc__form-label">Add Size</label>
                                                    <div class="form-group__input">
                                                        <input class="sherah-wc__form-input" placeholder="Type here"
                                                            type="text" name="p_title">
                                                        <button class="sherah-btn__add sherah-btn sherah-btn__secondary"
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="checkbox-group">
                                                                <div class="checkbox-group__single">
                                                                    ...
                                                                    <label class="checkbox-group__single--label"
                                                                        for="option1">MM</label>
                                                                </div>
                                                                <div class="checkbox-group__single">
                                                                    <input type="checkbox" class="btn-check"
                                                                ...
                                                                <div class="checkbox-group__single">
                                                                    <input type="checkbox" class="btn-check"
                                                                        name="options" id="option6" autocomplete="off">
                                                                    <label class="checkbox-group__single--label"
                                                                        for="option6">SM</label>
                                                                </div>
                                                                <div class="checkbox-group__single">
                                                                    <input type="checkbox" class="btn-check"
                                                                        name="options" id="option7" autocomplete="off">
                                                                    <label class="checkbox-group__single--label"
                                                                        for="option7">2X</label>
                                                                </div>
                                                                <div class="checkbox-group__single">
                                                                    <input type="checkbox" class="btn-check"
                                                                        name="options" id="option8" autocomplete="off">
                                                                    <label class="checkbox-group__single--label"
                                                                        for="option8">3X</label>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="col-lg-6 col-md-6 col-12">
                                                        <div class="form-group">
                                                            ...
                                                            <div class="checkbox-group">
                                                                <div class="checkbox-group__single">
                                                                    <input type="checkbox" class="btn-check"
                                                                        name="options" id="option9" autocomplete="off">
                                                                    <label class="checkbox-group__single--label"
                                                                        for="option9">White</label>
                                                                </div>
                                                                <div class="checkbox-group__single">
                                                                    <input type="checkbox" class="btn-check"
                                                                        name="options" id="option10" checked
                                                                        autocomplete="off">
                                                                    <label class="checkbox-group__single--label"
                                                                        for="option10">Black</label>
                                                                </div>
                                                                <div class="checkbox-group__single">
                                                                    <input type="checkbox" class="btn-check"
                                                                        name="options" id="option11" autocomplete="off">
                                                                    <label class="checkbox-group__single--label"
                                                                        for="option11">Harlequin</label>
                                                                </div>
                                                                <div class="checkbox-group__single">
                                                                    <input type="checkbox" class="btn-check"
                                                                        name="options" id="option12" autocomplete="off">
                                                                    <label class="checkbox-group__single--label"
                                                                        for="option12">Red</label>
                                                                </div>
                                                                <div class="checkbox-group__single">
                                                                    <input type="checkbox" class="btn-check"
                                                                        name="options" id="option13" autocomplete="off">
                                                                    <label class="checkbox-group__single--label"
                                                                        for="option13">Yellow</label>
                                                                </div>
                                                                <div class="checkbox-group__single">
                                                                    <input type="checkbox" class="btn-check"
                                                                        name="options" id="option14" autocomplete="off">
                                                                    <label class="checkbox-group__single--label"
                                                                        for="option14">Blue</label>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                        ...
                                        <div class="form-group">
                                            <div class="image-upload-group">
                                                ...
                                                <div class="image-upload-group__single image-upload-group__single--upload">
                                                    <input type="file" class="btn-check" name="options"
