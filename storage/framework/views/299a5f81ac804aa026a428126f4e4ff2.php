    ...
    <script>
        $(document).ready(function() {
            $('select[name="category_id"]').change(function() {
                ...
                if (categoryId) {
                    // Dynamically generate the route URL using Laravel's helper
...
<?php echo $__env->make('customer.index', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH F:\xampp\htdocs\multivendor-e-commerce-bidding-system\resources\views/customer/bid/customer-custom-bid-request.blade.php ENDPATH**/ ?>