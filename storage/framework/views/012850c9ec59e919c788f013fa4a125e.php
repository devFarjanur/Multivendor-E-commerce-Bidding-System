                                ...
                                <div class="col-12">
                                    <div class="sherah-breadcrumb mg-top-30">
                                        ...
                                        <ul class="sherah-breadcrumb__list">
                                            ...
                                            <li class="active"><a href="<?php echo e(route('vendor.bid.list')); ?>">Bid List</a></li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="sherah-table p-0">
                                    <table id="sherah-table__vendor" class="sherah-table__main sherah-table__main-v3">
                                        ...
                                        <tbody class="sherah-table__body">
                                            <?php if(count($vendorbidresults) > 0): ?>
                                                <?php $__currentLoopData = $vendorbidresults; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $bidRequest): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <tr>
...
<?php echo $__env->make('vendor.index', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\Multivendor-E-commerce-Bidding-System\resources\views/vendor/bid/bid-list.blade.php ENDPATH**/ ?>