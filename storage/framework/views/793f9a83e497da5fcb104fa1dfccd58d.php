                                ...
                                <div class="col-12">
                                    <div class="sherah-breadcrumb mg-top-30">
                                        ...
                                        <ul class="sherah-breadcrumb__list">
                                            ...
                                            <li class="active"><a href="<?php echo e(route('vendor.add.subcategory')); ?>">Add
                                                    Subcategory</a>
                                            </li>
                                        </ul>
                                    </div>
...
<?php echo $__env->make('vendor.index', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH F:\xampp\htdocs\multivendor-e-commerce-bidding-system\resources\views/vendor/category/add-category-subcategory.blade.php ENDPATH**/ ?>