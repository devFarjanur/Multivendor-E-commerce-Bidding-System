...
<head>
    ...
    <link
        ...
        rel="stylesheet">
    <!-- Fav Icon -->
    <link rel="icon" href="<?php echo e(asset('backend/assets/img/logo.png')); ?>">
    <!-- sherah Stylesheet -->
...
<body id="sherah-dark-light">
    ...
    <section class="sherah-wc sherah-wc__full sherah-bg-cover"
        style="background-image: url<?php echo e(asset('backend/assets/img/credential-bg.svg')); ?>;">
        <div class="container-fluid p-0">
            <div class="row g-0">
                <div class="col-lg-6 col-md-6 col-12 sherah-wc-col-one">
                    <div class="sherah-wc__inner"
                        style="background-image: url('<?php echo e(asset('backend/assets/img/welcome-bg.png')); ?>');">
                        <!-- Logo -->
                        <!-- Middle Image -->
                        <div class="sherah-wc__middle">
                            <a href=""><img src="<?php echo e(asset('backend/assets/img/welcome-vector.png')); ?>" alt="#"></a>
                        </div>
                        <!-- Welcome Heading -->
                ...
                <div class="col-lg-6 col-md-6 col-12 sherah-wc-col-two">
                    <div class="sherah-wc__form">
                        <div class="sherah-wc__form-inner">
                            ...
                            <!-- Sign in Form -->
                            <form class="sherah-wc__form-main p-0" method="post" action="<?php echo e(route('customer.login.post')); ?>">
                                <?php echo csrf_field(); ?>
                                ...
                                <div class="form-group mg-top-20">
                                    <div class="sherah-wc__bottom">
                                        <p class="sherah-wc__text">Dont’t have an account ? <a
                                                href="<?php echo e(route('customer.register')); ?>">Sign up free</a></p>
                                    </div>
                                </div>
                            </form>
                            <!-- End Sign in Form -->
...
</html><?php /**PATH F:\xampp\htdocs\multivendor-e-commerce-bidding-system\resources\views/customer/customer_login.blade.php ENDPATH**/ ?>