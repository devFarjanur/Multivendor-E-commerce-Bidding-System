                ...
                <div class="col-lg-6 col-md-6 col-12 sherah-wc-col-two">
                    <div class="sherah-wc__form">
                        <div class="sherah-wc__form-inner">
                            ...
                            <!-- Sign in Form -->
                            <form class="sherah-wc__form-main p-0" method="post" action="<?php echo e(route('vendor.login.post')); ?>">
                                <?php echo csrf_field(); ?>
                                ...
                                <div class="form-group mg-top-20">
                                    <div class="sherah-wc__bottom">
                                        <p class="sherah-wc__text">Dont’t have an account ? <a
                                                href="<?php echo e(route('vendor.register')); ?>">Sign up free</a></p>
                                    </div>
                                </div>
                            </form>
                            <!-- End Sign in Form -->
...
</html><?php /**PATH F:\xampp\htdocs\multivendor-e-commerce-bidding-system\resources\views/vendor/vendor_login.blade.php ENDPATH**/ ?>